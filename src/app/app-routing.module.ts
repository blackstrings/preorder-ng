...
import {UserCheckoutViewComponent} from "./views/user-views/user-checkout-view/user-checkout-view.component";
...
const routes: Routes = [
  ...
  {path: ViewRoutes.USER_CHECKOUT, component: UserCheckoutViewComponent, canActivate: [BasicViewGuard]},
